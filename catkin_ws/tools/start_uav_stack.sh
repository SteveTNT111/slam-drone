...
open_window "monitor_state" "source /opt/ros/noetic/setup.bash; while true; do clear; date; echo; echo '[mavros/state]'; rostopic echo -n 1 /mavros/state || true; sleep 1; done"
sleep 1

open_window "monitor_z" "source /opt/ros/noetic/setup.bash; while true; do clear; date; echo; echo '[FAST-LIO z]'; rostopic echo -n 1 /Odometry/pose/pose/position/z || true; echo; echo '[Vision Pose z]'; rostopic echo -n 1 /mavros/vision_pose/pose/pose/position/z || true; echo; echo '[Local Position z]'; rostopic echo -n 1 /mavros/local_position/pose/pose/position/z || true; sleep 1; done"
sleep 1

open_window "monitor_hz" "source /opt/ros/noetic/setup.bash; echo '正在监视 /Odometry /mavros/vision_pose/pose /mavros/local_position/pose 的频率...'; rostopic hz /Odometry /mavros/vision_pose/pose /mavros/local_position/pose"
